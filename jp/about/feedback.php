<?php
require "../../inc/jp_feedback_core.php";
?>
...
<div id="innerc_headertitle">情報のフィード・バック</div>
...
function mailsend() {
						...
						$.post('/jp/ajax_sendmessage2.php',{title:$("#title").val(),content:$("#content").val(),customername:$("#customername").val(),contact:$("#contact").val(),tel:$("#tel").val(),qqmsn:$("#qqmsn").val()},function(data) {
