<?php
require "../../inc/jp_productsorder_core.php";
?>
...
<div id="innerc_headertitle">注文</div>
...
function mailsend() {
						...
						$.post('/jp/ajax_sendmessage.php',{productname:$("#productname").val(),productsnum:$("#productsnum").val(),name:$("#name").val(),tel:$("#tel").val(),address:$("#address").val(),email:$("#email").val(),content:$("#content").val()},function(data) {
