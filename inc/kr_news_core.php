...
//取出信息二级目录
$strSQL = "select id_newsdir,name from newsdir where dele=1 and fatherid=34 order by ordernum asc " ;
...
$intRows = 20;
$strSQLNum = "SELECT COUNT(*) as num from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.lang=1  and b.fatherid='34'  order by a.id_newsinfo desc";   
...
$strSQL = "select a.* from newsinfo as a left join newsdir as b on a.id_newsdir=b.id_newsdir where a.dele=1 and b.lang=1  and b.fatherid='34'  order by a.id_newsinfo desc" ;
