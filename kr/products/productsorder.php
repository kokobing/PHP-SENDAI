<?php
require "../../inc/kr_productsorder_core.php";
?>
...
<div id="innerc_headertitle">오더</div>
...
function mailsend() {
						...
						$.post('/kr/ajax_sendmessage.php',{productname:$("#productname").val(),productsnum:$("#productsnum").val(),name:$("#name").val(),tel:$("#tel").val(),address:$("#address").val(),email:$("#email").val(),content:$("#content").val()},function(data) {
