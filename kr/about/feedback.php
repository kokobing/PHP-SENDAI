<?php
require "../../inc/kr_feedback_core.php";
?>
...
<div id="innerc_headertitle">고객센터</div>
...
function mailsend() {
						...
						$.post('/kr/ajax_sendmessage2.php',{title:$("#title").val(),content:$("#content").val(),customername:$("#customername").val(),contact:$("#contact").val(),tel:$("#tel").val(),qqmsn:$("#qqmsn").val()},function(data) {
